...
android {
    namespace = "tw.market.ledger.feature.watchlist"
    compileSdk = 35
...
dependencies {
    implementation(project(":core-model")); implementation(project(":core-network")); implementation(project(":core-database"))
