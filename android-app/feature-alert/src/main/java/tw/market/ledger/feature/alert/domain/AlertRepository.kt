...
class LocalNotificationDelivery:NotificationDeliveryProvider { override val status="LOCAL";private val delivered=mutableSetOf<String>();fun shouldDeliver(event:AlertEvent)=delivered.add(event.fingerprint?:event.id) }
